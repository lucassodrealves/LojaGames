package com.generation.gamesNovo.service;
	...
	public Optional<Usuario> cadastrarUsuario(Usuario usuario){
		if(usuarioRepository.findByUsuario(usuario.getUsuario()).isPresent()) {
			...
			if(usuario.getFoto()==null) {
				usuario.setFoto("https://imgur.com/gallery/fW1rh");
				
			
			}
				Long periodo=ChronoUnit.DAYS.between(usuario.getLocaldate(),usuario.getH());
